...
export class DBMigrate1655919360650 implements MigrationInterface {
  name = "DBMigrate1655919360650";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      "CREATE TYPE \"public\".\"breeding_transaction_status_enum\" AS ENUM('CREATED', 'CANCELED', 'EXPIRED', 'SUCCESS', 'BREEDING_REQUESTED', 'BREEDING_EXPIRED', 'BREEDING_CANCELED', 'IN_PROGRESS', 'BREEDING_FINISHED', 'BREEDING_SUCCESS', 'PAYMENTED')",
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      "CREATE TYPE \"public\".\"breeding_transaction_status_enum_old\" AS ENUM('CREATED', 'CANCELED', 'SUCCESS', 'PAYMENTED', 'BREEDING_FINISHED', 'BREEDING_REQUESTED', 'EXPIRED')",
    );
    await queryRunner.query(
